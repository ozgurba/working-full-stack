package org.monojhipster.web.rest;
...
import org.monojhipster.IntegrationTest;
import org.monojhipster.domain.Author;
import org.monojhipster.repository.AuthorRepository;
...
class AuthorResourceIT {
    ...
    private static final LocalDate DEFAULT_DATEOF_BIRTH = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATEOF_BIRTH = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author().name(DEFAULT_NAME).dateofBirth(DEFAULT_DATEOF_BIRTH);
        return author;
    }
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author().name(UPDATED_NAME).dateofBirth(UPDATED_DATEOF_BIRTH);
        return author;
    }
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getDateofBirth()).isEqualTo(DEFAULT_DATEOF_BIRTH);
    }
    ...
    void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateofBirth").value(hasItem(DEFAULT_DATEOF_BIRTH.toString())));
    }
    ...
    void getAuthor() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.dateofBirth").value(DEFAULT_DATEOF_BIRTH.toString()));
    }
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.name(UPDATED_NAME).dateofBirth(UPDATED_DATEOF_BIRTH);
        ...
        assertThat(testAuthor.getDateofBirth()).isEqualTo(UPDATED_DATEOF_BIRTH);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.dateofBirth(UPDATED_DATEOF_BIRTH);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.name(UPDATED_NAME).dateofBirth(UPDATED_DATEOF_BIRTH);
