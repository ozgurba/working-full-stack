    ...
    <Row>
      <Col md="8">
        <h2 data-cy="authorDetailsHeading">
          <Translate contentKey="monojhipsterApp.author.detail.title">Author</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="monojhipsterApp.author.name">Name</Translate>
            </span>
          </dt>
          <dd>{authorEntity.name}</dd>
          <dt>
            <span id="dateofBirth">
              <Translate contentKey="monojhipsterApp.author.dateofBirth">Dateof Birth</Translate>
            </span>
          </dt>
          <dd>
            {authorEntity.dateofBirth ? <TextFormat value={authorEntity.dateofBirth} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}
          </dd>
        </dl>
